...
return [
    ...
    */
    ...
    'mailers' => [
        ...
        'smtp' => [
            ...
            'timeout' => null,
            'local_domain' => env('MAIL_EHLO_DOMAIN', parse_url((string) env('APP_URL', env('AUTH_URL', 'http://localhost')), PHP_URL_HOST)),
        ],
    ...
    */
    ...
    'from' => [
        'address' => env('MAIL_FROM_ADDRESS', env('SMTP_FROM', 'hello@example.com')),
        'name' => env('MAIL_FROM_NAME', env('APP_NAME', 'Novastra')),
    ],
