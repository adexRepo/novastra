...
@section('content')
    <section class="page-shell py-12 sm:py-16">
        <div class="grid items-stretch gap-6 lg:grid-cols-[1.2fr_.8fr]">
            <div class="rounded-3xl bg-sand p-7 sm:p-10 lg:p-14">
                <p class="eyebrow">Tentang Novastra</p>
                <h1 class="section-title mt-4 max-w-3xl">Supplying quality, delivering trust.</h1>
                <p class="mt-7 max-w-2xl text-lg leading-8 text-ink/65">CV Novastra Global Supply bergerak di bidang perdagangan, pengadaan, dan distribusi bahan pangan untuk kebutuhan rumah, bisnis, dapur, katering, industri, dan institusi.</p>
            ...
            <div class="flex flex-col justify-between rounded-3xl bg-ink p-7 text-white sm:p-10">
                ...
                <div class="mt-16">
                    ...
                    <p class="mt-2 text-2xl font-semibold">CV Novastra Global Supply</p>
                    <p class="mt-5 text-sm leading-6 text-white/55">PMDN · Usaha Mikro<br>Cisauk, Kabupaten Tangerang, Banten</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-ink py-16 text-white sm:py-20">
        <div class="page-shell grid gap-12 lg:grid-cols-2">
            <div>
                ...
                <h2 class="mt-4 font-display text-4xl leading-tight sm:text-5xl">Menjadi perusahaan distribusi dan pengadaan pangan yang profesional, terpercaya, dan berdaya saing nasional.</h2>
            </div>
            <div>
    ...
    <section class="bg-sand/60 py-16 sm:py-20">
        <div class="page-shell grid gap-12 lg:grid-cols-[.8fr_1.2fr]">
            <div><p class="eyebrow">Legalitas usaha</p><h2 class="section-title mt-3">Identitas perusahaan yang jelas.</h2><p class="mt-5 leading-7 text-ink/60">Informasi berikut diringkas dari dokumen resmi perusahaan. Dokumen legal lengkap tersedia bagi calon mitra melalui permintaan resmi.</p><a class="btn mt-7" href="{{ route('contact') }}">Hubungi tim Novastra</a></div>
            <dl class="grid gap-4 sm:grid-cols-2">
                <div class="card p-6"><dt class="text-xs uppercase tracking-[.18em] text-ink/45">Nomor Induk Berusaha</dt><dd class="mt-3 text-xl font-semibold">2402260050323</dd><p class="mt-2 text-sm text-ink/55">Diterbitkan melalui OSS pada 24 Februari 2026.</p></div>
                <div class="card p-6"><dt class="text-xs uppercase tracking-[.18em] text-ink/45">Bidang utama</dt><dd class="mt-3 text-xl font-semibold">Pengadaan bahan pangan</dd><p class="mt-2 text-sm text-ink/55">Perdagangan, supply, dan distribusi.</p></div>
                <div class="card p-6"><dt class="text-xs uppercase tracking-[.18em] text-ink/45">Domisili</dt><dd class="mt-3 text-xl font-semibold">Cisauk, Tangerang</dd><p class="mt-2 text-sm text-ink/55">Provinsi Banten, Indonesia.</p></div>
                <div class="card p-6"><dt class="text-xs uppercase tracking-[.18em] text-ink/45">Kepatuhan</dt><dd class="mt-3 text-xl font-semibold">Komitmen K3L</dd><p class="mt-2 text-sm text-ink/55">Pernyataan mandiri tersimpan melalui sistem OSS.</p></div>
            </dl>
        </div>
    </section>
